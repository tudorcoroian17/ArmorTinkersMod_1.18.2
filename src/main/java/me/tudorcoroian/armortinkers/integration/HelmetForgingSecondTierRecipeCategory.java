...
public class HelmetForgingSecondTierRecipeCategory implements IRecipeCategory<HelmetForgingRecipeSecondTier> {
    public final static ResourceLocation UID = new ResourceLocation(ArmorTinkers.MOD_ID, "helmet_forging_t2");
    public final static ResourceLocation TEXTURE =
            new ResourceLocation(ArmorTinkers.MOD_ID, "textures/gui/armor_forge_tier_2_helmet_jei.png");

    private final IDrawable background;
    private final IDrawable icon;

    public HelmetForgingSecondTierRecipeCategory(IGuiHelper helper) {
    ...
    @Override
    public Class<? extends HelmetForgingRecipeSecondTier> getRecipeClass() {
        return HelmetForgingRecipeSecondTier.class;
    }
    ...
    @Override
    public void setRecipe(@Nonnull IRecipeLayoutBuilder builder, @Nonnull HelmetForgingRecipeSecondTier recipe, @Nonnull IFocusGroup focusGroup) {
