...
import me.tudorcoroian.armortinkers.recipe.BootsForgingRecipeFirstTier;
...
public class BootsForgingFirstTierRecipeCategory implements IRecipeCategory<BootsForgingRecipeFirstTier> {
    public final static ResourceLocation UID = new ResourceLocation(ArmorTinkers.MOD_ID, "boots_forging_t1");
    public final static ResourceLocation TEXTURE =
            new ResourceLocation(ArmorTinkers.MOD_ID, "textures/gui/armor_forge_tier_1_boots_jei.png");

    private final IDrawable background;
    private final IDrawable icon;

    public BootsForgingFirstTierRecipeCategory(IGuiHelper helper) {
    ...
    @Override
    public Class<? extends BootsForgingRecipeFirstTier> getRecipeClass() {
        return BootsForgingRecipeFirstTier.class;
    }
    ...
    @Override
    public void setRecipe(@Nonnull IRecipeLayoutBuilder builder, @Nonnull BootsForgingRecipeFirstTier recipe, @Nonnull IFocusGroup focusGroup) {
