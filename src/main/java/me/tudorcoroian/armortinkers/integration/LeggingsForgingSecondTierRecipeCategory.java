...
public class LeggingsForgingSecondTierRecipeCategory implements IRecipeCategory<LeggingsForgingRecipeSecondTier> {
    public final static ResourceLocation UID = new ResourceLocation(ArmorTinkers.MOD_ID, "leggings_forging_t2");
    public final static ResourceLocation TEXTURE =
            new ResourceLocation(ArmorTinkers.MOD_ID, "textures/gui/armor_forge_tier_2_leggings_jei.png");

    private final IDrawable background;
    private final IDrawable icon;

    public LeggingsForgingSecondTierRecipeCategory(IGuiHelper helper) {
    ...
    @Override
    public Class<? extends LeggingsForgingRecipeSecondTier> getRecipeClass() {
        return LeggingsForgingRecipeSecondTier.class;
    }
    ...
    @Override
    public void setRecipe(@Nonnull IRecipeLayoutBuilder builder, @Nonnull LeggingsForgingRecipeSecondTier recipe, @Nonnull IFocusGroup focusGroup) {
