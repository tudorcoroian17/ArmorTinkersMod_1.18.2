...
public enum ModArmorMaterials implements ArmorMaterial {
    HIDE("hide", 1, new int[]{1, 1, 1, 1}, 0, SoundEvents.ARMOR_EQUIP_LEATHER, 0.0F, 0.0F, () -> {
        return Ingredient.of(Items.LEATHER);
    });

    private static final int[] HEALTH_PER_SLOT = new int[]{5, 6, 6, 5};
    ...
    public String getName() {
        return ArmorTinkers.MOD_ID + ":" + this.name;
    }
