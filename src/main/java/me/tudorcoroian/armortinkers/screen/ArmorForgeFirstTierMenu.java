...
public class ArmorForgeFirstTierMenu extends AbstractContainerMenu {

    private final ArmorForgeFirstTierBlockEntity blockEntity;
    ...
    public ArmorForgeFirstTierMenu(int windowId, Inventory inv, FriendlyByteBuf extraData) {
    ...
    public ArmorForgeFirstTierMenu(int windowId, Inventory inv, BlockEntity blockEntity, ContainerData data) {
        super(ModMenuTypes.ARMOR_FORGE_TIER_1_MENU.get(), windowId);
        checkContainerSize(inv, ModArmorForgeSlots.getNumberOfSlots());
        this.blockEntity = ((ArmorForgeFirstTierBlockEntity) blockEntity);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.ARMOR_FORGE_TIER_1.get());
    }
