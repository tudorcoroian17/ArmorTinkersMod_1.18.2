...
public class ArmorForgeFirstTierScreen extends AbstractContainerScreen<ArmorForgeFirstTierMenu> {
    private static final ResourceLocation TEXTURE_HELMET =
            new ResourceLocation(ArmorTinkers.MOD_ID, "textures/gui/armor_forge_tier_1_helmet.png");
    private static final ResourceLocation TEXTURE_CHESTPLATE =
            new ResourceLocation(ArmorTinkers.MOD_ID, "textures/gui/armor_forge_tier_1_chestplate.png");
    private static final ResourceLocation TEXTURE_LEGGINGS =
            new ResourceLocation(ArmorTinkers.MOD_ID, "textures/gui/armor_forge_tier_1_leggings.png");
    private static final ResourceLocation TEXTURE_BOOTS =
            new ResourceLocation(ArmorTinkers.MOD_ID, "textures/gui/armor_forge_tier_1_boots.png");
    ...
    public ArmorForgeFirstTierScreen(ArmorForgeFirstTierMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
